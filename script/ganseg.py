...
from lib.netdissect.progress import default_progress, verbose_progress
from lib.netdissect.autoeval import autoimport_eval
from lib.netdissect.workerpool import WorkerBase, WorkerPool
from lib.netdissect.nethook import edit_layers, retain_layers
...
def main():
    ...
    parser.add_argument('--model', type=str, default=
            ...
            '/mnt/disk1/gandissect/models/karras/bedroom_lsun.pth")',
